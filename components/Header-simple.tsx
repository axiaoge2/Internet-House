...
import { translations, getLocaleFromPathname, getLocalizedPath } from '@/lib/i18n';
...
export default function Header() {
  ...
  const navLinks = [
    { href: '/', icon: '🏠', textKey: 'nav.home' },
    { href: '/blog', icon: '💭', textKey: 'nav.blog' },
    { href: '/category', icon: '🏠', textKey: 'nav.categories' },
    { href: '/tag', icon: '🏷️', textKey: 'nav.tags' },
    { href: '/about', icon: '👤', textKey: 'nav.about' },
  ];
      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6">
            {navLinks.map((link) => {
              const labelKey = link.textKey as keyof typeof t;
